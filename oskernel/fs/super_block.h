#ifndef __GOS_OSKERNEL_SUPER_BLOCK_H__
#define __GOS_OSKERNEL_SUPER_BLOCK_H__
#include "types.h"

/* 超级块 */
struct super_block {
    uint32_t magic;                 //用来标识文件系统类型，支持多文件系统的操作系统通过此标识来识别文件系统类型
    ...
    uint32_t inode_bitmap_secs;     //inode位图占用的扇区数量
